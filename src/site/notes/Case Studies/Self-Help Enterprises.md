...
1. strengthen agreements with participants about data sharing, 
...
The third and final module focused on data products and risk. SHE is in the process of creating a data repository for data from site well assessments. They are currently working to anonymize and de-identify the data, but also want to create products that aggregate the data.
